...
Revision ID: 3907c3bffb2f
Revises: a4e6791e688f
Create Date: 2025-08-20 14:16:52.660381
...
revision: str = '3907c3bffb2f'
down_revision: Union[str, Sequence[str], None] = 'a4e6791e688f'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('admin', schema=None) as batch_op:
        batch_op.drop_index('uq_admin_email')
    ...
    with op.batch_alter_table('toy_stock', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('toy_status', sa.Enum('PENDING', 'FOR_SALE', 'REJECTED', 'DONATION', 'END_BUY', 'SUBMIT', name='toystatus'), nullable=False))
        ...
        batch_op.alter_column('updated_at',
               ...
               nullable=True)
        batch_op.drop_constraint('fk_toy_stock_donor_id_user', type_='foreignkey')
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('toy_stock', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_toy_stock_donor_id_user', 'user', ['donor_id'], ['user_id'])
        batch_op.alter_column('updated_at',
               existing_type=mysql.DATETIME(),
               nullable=False)
        batch_op.alter_column('is_donatable',
    ...
    with op.batch_alter_table('admin', schema=None) as batch_op:
        batch_op.create_index('uq_admin_email', ['email'], unique=False)
